...
(function(){
  ...
  if(!drawer){
    ...
    // clone links from first .nav-links
    const src = document.querySelector('.nav-links');
    if(src){
      drawer.innerHTML = src.outerHTML.replace('class="nav-links"','class="nav-list"');
    } else {
      drawer.innerHTML = '<a href="index.html">Home</a><a href="dark-event.html">Dark</a><a href="light-corsi.html">Light</a>';
    }
